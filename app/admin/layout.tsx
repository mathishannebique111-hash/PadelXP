    ...
    return (
      <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[rgb(var(--theme-secondary-accent))] mx-auto mb-4" style={{ borderColor: 'rgb(var(--theme-secondary-accent)) transparent rgb(var(--theme-secondary-accent)) transparent' }}></div>
