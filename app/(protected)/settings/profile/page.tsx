...
export default function EditProfilePage() {
    ...
    return (
        <div className="relative min-h-screen pb-20 bg-theme-bg">
            ...
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(0,102,255,0.1),transparent)] z-0 pointer-events-none hide-in-club" />
            ...
            <div className="relative z-10 mx-auto w-full max-w-2xl px-4 py-6">
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <h1 className="text-2xl font-bold" style={{ color: isClub ? 'var(--theme-text)' : 'white' }}>Modifier mon profil</h1>
                </div>
