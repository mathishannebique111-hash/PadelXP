  ...
  if (!userParticipations || userParticipations.length === 0) {
    return (
      <div className="rounded-2xl bg-white/10 border border-white/20 p-8 text-center backdrop-blur">
        ...
        <Link href="/match/new" className="mt-4 inline-block rounded-xl px-6 py-2.5 text-sm font-black uppercase tracking-widest transition-all active:scale-95" style={{ backgroundColor: 'rgb(var(--theme-accent))', color: 'var(--theme-accent-contrast, var(--theme-player-page, #071554))', boxShadow: '0 0 15px rgba(var(--theme-accent), 0.3)' }}>
