...
export default function HeaderLogo({ logoUrl }: HeaderLogoProps) {
    ...
    return (
        <div className={`${isClubLogo ? 'fixed' : 'absolute'} top-0 left-0 right-0 z-5 pointer-events-none flex justify-center site-header-logo [.questionnaire-open_&]:hidden`} style={{ top: isClubLogo ? 'calc(var(--sat, 0px) + 0.5rem)' : 'calc(var(--sat, 0px) - 2.5rem)' }}>
