        ...
        <nav className="p-4 pt-20 space-y-2 text-sm flex-1 h-full overflow-y-auto">
          ...
          <div className="pt-4 mt-4 border-t border-white/10 space-y-2">
            <Link
              href="/settings"
              onClick={() => setIsOpen(false)}
              className="flex items-center gap-3 px-4 py-3 rounded-xl bg-gradient-to-r from-white/5 to-white/5 text-white/90 border border-white/10 hover:from-gray-500/20 hover:to-gray-600/20 hover:border-gray-400/40 hover:text-white hover:shadow-[0_4px_12px_rgba(107,114,128,0.25)] hover:scale-[1.02] active:scale-100 transition-all duration-300"
            >
