        ...
        <div className="mb-4">
          ...
          <div className="mb-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <button
                ...
                disabled={!canShare}
                className={`px-4 py-3 rounded-lg font-semibold text-sm transition-all ${canShare
          ...
          <div className="mb-4 rounded-lg bg-white/5 border border-white/10 p-3">
            ...
            <div className="h-2 w-full rounded-full bg-white/10 overflow-hidden">
              <div
                className={`h-full rounded-full transition-all ${isMaxReached
                    ? "bg-green-500"
          ...
          <div className="mt-4 rounded-lg bg-blue-500/10 border border-blue-500/20 p-3">
            <p className="text-xs text-white/80">
              Partagez votre code avec vos amis ! Vous recevrez <strong className="text-white">15 jours de Premium offerts</strong> pour chaque filleul qui s'inscrit, et ils recevront aussi <strong className="text-white">15 jours de Premium offerts</strong>.
            </p>
          </div>
        </div>
      </div>
