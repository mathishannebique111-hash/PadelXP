            ...
            <div className="mb-4">
              <div className="flex gap-1.5 mb-3">
                {[1, 2, 3, 4, 5].map((star) => (
                  <span
                    key={star}
                    className={`text-xl sm:text-2xl ${star <= submittedReview.rating
                        ? "drop-shadow-[0_0_4px_rgba(255,215,0,0.6)]"
                        : "text-slate-300"
                      }`}
                    style={{ color: star <= submittedReview.rating ? 'rgb(var(--theme-secondary-accent))' : undefined }}
                  >
                    ★
                  </span>
                ))}
        ...
        <div className="flex gap-2 sm:gap-3">
          {[1, 2, 3, 4, 5].map((star) => (
            <button
              ...
              className={`text-[36px] sm:text-[40px] leading-none transition-all duration-150 ${star <= rating
                  ? "drop-shadow-[0_0_8px_rgba(255,215,0,0.7)] scale-105"
                  : "text-slate-300"
                } hover:scale-110 hover:drop-shadow-[0_0_10px_rgba(255,215,0,0.8)] active:scale-95`}
              style={{ color: star <= rating ? 'rgb(var(--theme-secondary-accent))' : undefined }}
            >
              ★
            </button>
          ))}
      ...
      <div>
        ...
        <div className="relative">
          <textarea
            ...
            maxLength={500}
            rows={5}
            className="w-full px-4 py-3 rounded-xl bg-slate-800/90 text-white border border-slate-600/50 focus:outline-none focus:ring-2 transition-all resize-none"
            style={{ '--tw-ring-color': 'rgb(var(--theme-accent))' } as any}
          />
          {!comment && (
