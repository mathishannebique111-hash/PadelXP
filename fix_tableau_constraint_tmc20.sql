-- Script de correction immédiate pour la contrainte tableau
-- À exécuter dans Supabase SQL Editor pour corriger l'erreur

-- Supprimer l'ancienne contrainte
ALTER TABLE tournament_matches
DROP CONSTRAINT IF EXISTS tournament_matches_tableau_check;

-- Recréer la contrainte avec toutes les valeurs nécessaires pour TMC 8, 12, 16 et 20
ALTER TABLE tournament_matches
