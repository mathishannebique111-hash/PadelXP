...
export const PADEL_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      { label: "Réactif / Surpris", description: "Souvent surpris par la trajectoire, je cours après la balle une fois le filet dépassé.", points: 1 },
      { label: "Lecture à l'impact", description: "Je bouge au moment précis de la frappe adverse ; mon placement est souvent en retard.", points: 3 },
      { label: "Placement de sécurité", description: "J'anticipe les zones classiques (centre/vitre) et je suis bien placé la plupart du temps.", points: 6 },
      { label: "Lecture de la préparation", description: "J'observe la préparation adverse pour me déplacer juste avant l'impact et couvrir la zone logique.", points: 8 },
      { label: "Lecture intuitive", description: "Je lis le jeu avant même l'armement du coup. Je prévois les feintes et suis 'déjà là' quand la balle arrive.", points: 10 },
    ],
  },
  {
    id: 10,
    ...
    options: [
      { label: "Silence ou on se gêne", description: "Pas de communication, on se gène sur le terrain.", points: 1 },
      { label: "Basique", description: "Uniquement annonces de sécurité ('J'ai', 'Laisse').", points: 4 },
      { label: "Annonces tactiques", description: "Annonces systématiques des positions adverses.", points: 7 },
      { label: "Coopération & Stratégie", description: "Choix tactiques communs et analyse en temps réel.", points: 10 },
    ],
  },
  {
    id: 11,
  ...
  },
  {
    ...
    options: [
      { label: "Victoires en poules / Quarts P25", points: 1 },
      { label: "Victoire P25 / Passe des tours en P100", points: 2 },
      { label: "Podium P100", points: 3 },
      { label: "Victoire P100 / Passe des tours en P250", points: 4.5 },
      { label: "Podium P250", points: 5.5 },
      { label: "Victoire P250 / Passse des tours en P500", points: 7 },
      { label: "Podium P500", points: 8 },
      { label: "Victoire P500 / Passe des tours en P1000", points: 9 },
