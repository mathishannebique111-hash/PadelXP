...
export const PADEL_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      { label: "Souvent surpris par la trajectoire, je cours après la balle une fois le filet dépassé.", points: 1 },
      { label: "Je bouge au moment précis de la frappe adverse ; mon placement est souvent en retard.", points: 3 },
      { label: "J'anticipe les zones classiques (centre/vitre) et je suis bien placé la plupart du temps.", points: 6 },
      { label: "J'observe la préparation adverse pour me déplacer juste avant l'impact et couvrir la zone logique.", points: 8 },
      { label: "Je lis le jeu avant même l'armement du coup. Je prévois les feintes et suis 'déjà là' quand la balle arrive.", points: 10 },
    ],
  },
  {
    id: 10,
    ...
    options: [
      { label: "Pas de communication, on se gène sur le terrain.", points: 1 },
      { label: "Uniquement annonces de sécurité ('J'ai', 'Laisse').", points: 4 },
      { label: "Annonces systématiques des positions adverses.", points: 7 },
      { label: "Choix tactiques communs et analyse en temps réel.", points: 10 },
    ],
  },
  {
    id: 11,
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Victoire P250 / Passe des tours en P500", points: 7 },
