-- =====================================================
-- SCRIPT SQL POUR RÉINITIALISER TOUS LES CLUBS
-- =====================================================
-- 
-- ⚠️ ATTENTION : Ce script réinitialise TOUS les clubs
-- Utilisez-le uniquement pour les tests en développement
-- 
-- Exécutez ce script dans Supabase SQL Editor
-- =====================================================

-- Supprimer tous les abonnements existants dans la table subscriptions
DELETE FROM subscriptions
WHERE club_id IS NOT NULL;

-- Réinitialiser les clubs
UPDATE clubs
SET
...
-- Afficher les clubs réinitialisés
SELECT 
  c.id,
  c.name,
  c.slug,
